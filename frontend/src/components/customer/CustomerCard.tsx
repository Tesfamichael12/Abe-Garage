      ...
      <div className="  px-4 py-5 md:flex gap-10">
        ...
        {customer?.data && customer.data.customer ? (
          <div>
            ...
            <p className="mb-1 text-lg text-customBlue font-semibold">
              ...
              <span className="text-gray-500">
                {customer.data.customer.customer_email}
              </span>
            </p>
            <p className="mb-1 text-lg text-customBlue font-semibold">
              Phone Number:
            ...
            <p className=" text-lg text-customBlue font-semibold">
              Active customer:
              <span className="text-gray-500">
                {customer.data.customer.active_customer_status ? "Yes" : "No"}
              </span>
            </p>
          ...
          <div className="  flex-grow">
            <p className="border   border-gray-200 text-customeRed text-center p-4  font-semibold">
              No customer found
            </p>
          </div>
        )}
